...
<body class="connect-next-body">
    ...
    @php($localizedRoute = fn (string $name, array $parameters = []) => route($name, ['locale' => $currentLocale] + $parameters))
    <div class="topline"></div>
    <header class="site-header connect-header">
        <a class="brand" href="{{ $localizedRoute('home') }}" aria-label="Connect Next home">
        ...
        <nav class="main-nav" data-nav>
            <a class="{{ request()->routeIs('home') ? 'active' : '' }}" href="{{ $localizedRoute('home') }}">{{ __('public.nav.home') }}</a>
            <a class="{{ request()->routeIs('ai') ? 'active' : '' }}" href="{{ $localizedRoute('ai') }}">{{ __('public.nav.ai') }}</a>
            <a class="{{ request()->routeIs('development') ? 'active' : '' }}" href="{{ $localizedRoute('development') }}">{{ __('public.nav.development') }}</a>
            <a class="{{ request()->routeIs('communities') ? 'active' : '' }}" href="{{ $localizedRoute('communities') }}">{{ __('public.nav.communities') }}</a>
            <a class="{{ request()->routeIs('awards*') ? 'active' : '' }}" href="{{ $localizedRoute('awards') }}">{{ __('public.nav.awards') }}</a>
            <a class="{{ request()->routeIs('projects') ? 'active' : '' }}" href="{{ $localizedRoute('projects') }}">{{ __('public.nav.projects') }}</a>
            <a class="{{ request()->routeIs('about') ? 'active' : '' }}" href="{{ $localizedRoute('about') }}">{{ __('public.nav.about') }}</a>
            <a class="{{ request()->routeIs('contact') ? 'active' : '' }}" href="{{ $localizedRoute('contact') }}">{{ __('public.nav.contact') }}</a>
        </nav>
        <div class="header-actions connect-header-actions">
            <a class="icon-button" href="{{ $localizedRoute('search') }}" aria-label="Zoeken">&#8981;</a>
    ...
    <footer class="footer connect-footer">
        <div class="footer-main">
            <div>
                <a class="brand brand-light" href="{{ $localizedRoute('home') }}">
                    <span class="brand-mark">CN</span>
                    <span>
                        <strong>{{ __('public.brand.name') }}</strong>
                        <small>{{ __('public.brand.tagline') }}</small>
            ...
            <div>
                ...
                <a href="{{ $localizedRoute('ai') }}">Connect Next AI</a>
                <a href="{{ $localizedRoute('development') }}">Connect Next Development</a>
                <a href="{{ $localizedRoute('communities') }}">Connect Next Communities</a>
            </div>
            <div>
                <strong>{{ __('public.footer.platform') }}</strong>
                <a href="{{ $localizedRoute('awards') }}">Connect Next Awards</a>
                <a href="{{ $localizedRoute('nieuws') }}">{{ __('public.nav.news') }}</a>
                <a href="{{ $localizedRoute('projects') }}">{{ __('public.nav.projects') }}</a>
            </div>
            <div>
                <strong>{{ __('public.footer.company') }}</strong>
                <a href="{{ $localizedRoute('about') }}">{{ __('public.nav.about') }}</a>
                <a href="{{ $localizedRoute('contact') }}">{{ __('public.nav.contact') }}</a>
                <a href="{{ $localizedRoute('partners') }}">Partners</a>
            </div>
        </div>
        <div class="footer-bottom">
            <span>&copy; {{ date('Y') }} {{ __('public.brand.name') }}. {{ __('public.footer.rights') }}</span>
